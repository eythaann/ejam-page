...
export default function Product() {
  return <div className={styles.productPage}>
    ...
    <div className={styles.steps}>
      <div>
        <div className={cx(styles.circle, styles.completed)}><Icon name="check" sizeText={'60%'}/></div>
      ...
      <div className={styles.active}>
        <div className={cx(styles.circle, styles.current)}>3</div>
    ...
    <div className={styles.container}>
      ...
      <div className={styles.description}>
        <div><Icon name="check_blue" size={16}/><span>Negative Ion Technology may <b>help with allergens</b></span></div>
        <div><Icon name="check_blue" size={16}/><span>Designed for <b>air rejuvenation</b></span></div>
        <div><Icon name="check_blue" size={16}/><span><b>Perfect for every room</b> in all types of places.</span></div>
      </div>
